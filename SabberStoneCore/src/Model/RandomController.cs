...
=======
		public virtual string PickBasicTotem(List<string> totems) => Util.Choose<string>(totems);
>>>>>>> test: add control tests
...
=======
		public virtual string PickEntourage(IEntity source, IEntity target, List<string> cards)
>>>>>>> test: add control tests
		{
...
=======
		public virtual IPlayable PickTarget(EntityType type, IEntity source, IEntity target, List<IPlayable> entities) {
>>>>>>> test: add control tests
	...
	public class ThrowRandomController : IRandomController
	{
		...
		public virtual string PickBasicTotem(List<string> totems) => throw new Exception("PickBasicTotem not implemented");
		...
		public virtual string PickEntourage(IEntity source, IEntity target, List<string> cards) => throw new Exception("PickEntourage not implemented");
